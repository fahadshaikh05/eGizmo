...
<sql:setDataSource var="myDS" driver="com.mysql.jdbc.Driver"
		...
		<sql:query var="gaminggadets" dataSource="${myDS}">
        SELECT productId,name,cost,imagePath FROM product where category="gaming";
    </sql:query>
<table id= "phones"   cellpadding="5" >
				...
				<c:forEach var="prod" items="${gaminggadets.rows}">
					<tr>
