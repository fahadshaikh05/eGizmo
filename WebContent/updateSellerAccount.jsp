...
%>
	...
	<div id="register">
		...
		<table align='center'>
			<form action='updatedSellerAccount.jsp' method='post'>
			<c:forEach var="row" items="${result.rows}">
				<tr align='center'>
					<td colspan='2'><h3>My Account</h3></td>
				<tr>
					<td>Company Name :</td>
					<td><input type="hidden" value="${param.sellerId}" name="sellerId"/>
					<input type='text' name='companyName' value="${row.companyName}" ></td>
				</tr>
				<tr>
					<td>Email Address :</td>
				...
				<tr>
					<td>URL :</td>
					<td><input id="URL" type="text" name="URL" value="${row.URL}" ></td>
					
				</tr>

				<tr>
					<td>Shipping Options :</td>
					<td><input id="ShippingOptions" type="text" name="ShippingOptions" value="${row.ShippingOptions}"></td>
					
				</tr>
				<tr>
					<td>Notification :</td>
					<td><input id="Notification" type="text" name="Notification" value="${row.Notification}" ></td>
					
				</tr>
				<tr>
					<td>Account Number:</td>
					<td><input id="accountNumber" type="text" name="accountNumber" value="${row.accountNumber}" ></td>
					
				</tr>
				<tr>
					<td>Routing Number :</td>
					<td><input id="routingNumber" type="text" name="routingNumber" value="${row.routingNumber}" ></td>
				</tr>
				<tr>
					<td>User Name:</td>
				...
				<tr>
					<td>Password :</td>
					<td><input id="password" type="text" name="password" value="${row.password}"></td>
				</tr>
			<tr >
