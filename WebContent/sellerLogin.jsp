...
<div id="loginNew">
<form id="signInForm" name="BuyerLoginServlet" method="post" action="LoginServlet">
<table id="signin" >
<tr>
<td>
...
<td><form action="sellerSignUp.jsp"><input id="RegisterSubmit" type="submit" value="Register"/></form></td>
</tr>
</table>
</form>
</div> 
